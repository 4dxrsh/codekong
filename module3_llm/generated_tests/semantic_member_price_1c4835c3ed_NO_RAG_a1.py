...
def test_member_price_off_by_one():
    ...
    assert member_price(500.0, "gold") == 450.0, "Gold tier should apply a 15% discount"
    assert member_price(0.0, "bronze") == 0.0, "Zero amount should return zero"
    assert member_price(-100.0, "bronze") == -95.0, "Negative amount should be discounted correctly"